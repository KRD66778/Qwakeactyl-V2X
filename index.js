...
console.log('\x1b[36m%s\x1b[0m', "Qwakeactyl: Starting...");

// cheks if cdn is online or not
 console.log(chalk.green("[Qwakeactyl] CDN Loading..."));
var http = require('http');
http.get('http://cdn.qwakeactyl.ml',function (res) {
  console.log(chalk.green("[Qwakeactyl] CDN Loaded..."));
...
function getCookie(req, cname) {
  ...
  //if cdn is down then
    console.log(chalk.red(`[Qwakeactyl] The Cdn Is Down Or Under Maintanance`));
